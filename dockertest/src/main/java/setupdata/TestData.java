...
public class TestData {
	...
	public static String newTestName = TestData.testDataFile.getValue("/NEW_TEST_NAME").toString();
	public static String newMethodName = TestData.testDataFile.getValue("/NEW_METHOD_NAME").toString();
	public static String projectName = TestData.testDataFile.getValue("/PROJECT_NAME").toString();
	public static String newLogMessage = TestData.testDataFile.getValue("/NEW_LOG_MESSAGE").toString();
